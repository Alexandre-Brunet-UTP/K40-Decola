...
##                    plt.plot(X,Y)
            ...
            if output_filename != None:
                self.write_egv_to_file(data,output_filename, laservalue)
            else:
...
##                    plt.plot(X,Y)
            ...
            if output_filename != None:
                (data,output_filename,use_laser)
            else:
                self.send_egv_data(data, 1, output_filename)
                self.menu_View_Refresh()
...
##                    plt.plot(X,Y)
            ...
            if output_filename != None:
                self.write_egv_to_file(data,output_filename,use_laser)
            else:
                self.send_egv_data(data, 1, output_filename)
                self.menu_View_Refresh()
    ...
    ##########################################################################
    ##########################################################################
    def write_egv_to_file(self,data,fname, laservalue):
        if len(data) == 0:
        ...
        fout.write("Laser Value : \n")
        fout.write("%s" %(laservalue))
...
##                            plot_im = plot_im.filter(filter)
                        ...
                        if self.rotate.get():
                            plot_im = plot_im.rotate(0,expand=True)
